...
p_load(knitr,tidyverse,rstatix,psych,scales,Hmisc,
       statstring,openxlsx,cowplot,afex,lsmeans,flextable,
       lavaan, semTools, finalfit, ggpubr,
...
```{r,warning=F,message=F}
#consc -----
analysis.cols <- get_cols %>% 
  mutate(vnames = str_remove_all(facet.vnames, "work[.]")) %>% 
  filter(!duplicated(vnames))
analysis.cols <- analysis.cols$vnames
